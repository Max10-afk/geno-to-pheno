...
fc_reg2 = keras.regularizers.L2(5e-2)
...
class trait_pred(Model):
    def __init__(self, width = 5, depth = 5, **kwargs):
        ...
        self.sd_layer = layers.Dense(units = 6, kernel_regularizer=fc_reg2)
        self.sd_layer1 = layers.Dense(units = 3, kernel_regularizer=fc_reg2)
        self.mean_layer = layers.Dense(units = 6, kernel_regularizer=fc_reg2)
        self.mean_layer1 = layers.Dense(units = 3, kernel_regularizer=fc_reg2)
