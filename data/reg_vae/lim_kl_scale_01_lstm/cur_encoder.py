...
class encoder(Model):
    def __init__(self, latent_dim, width = 1,**kwargs):
        ...
        self.blocks = []
        self.ini_layer1 = layers.Conv2D(filters = 1, kernel_size = (1, 2), data_format = "channels_first")
        self.ini_layer2 = layers.MaxPool2D(pool_size = (2, 2), data_format = "channels_first")
        self.ini_layer3 = layers.Lambda(tf.squeeze)
        self.ini_layer4 = layers.LSTM(latent_dim * 3, kernel_initializer = tf.keras.initializers.Zeros())
    ...
    def call(self, x, training = False):
        ...
        for block in self.blocks:
            ...
            for layer in block:
                ...
                #print(f"sub_x.shape: {sub_x.numpy()}")
